...
import ShowOnLogin from "../protect/Protect";
...
const Header = () => {
  ...
  return (
    <header className=" sticky top-0 shadow  gap-2 w-full z-40 bg-white">
      <nav className=" w-[90%] mx-auto flex items-center py-2 lg:py-3 justify-between">
        <button className=" lg:hidden" onClick={() => setCategory(true)}>
          <svg
        ...
        <input
          className=" hidden lg:block p-2.5 w-[65%]  bg-gray-50 border rounded-xl placeholder:text-sm placeholder:font-light"
          type="text"
      ...
      <div className=" w-[90%] mx-auto  flex py-2 justify-between lg:hidden">
        <NavLink
          to="/"
          className={({ isActive }) =>
            isActive ? " text-emerald-500" : " text-gray-700"
        ...
        >
          <div className=" flex flex-col justify-center gap-1 items-center">
            ...
            <p className=" text-[10px] tracking-wider">
              Cart <ShowOnLogin>{cartQuantity > 0 && cartQuantity}</ShowOnLogin>
            </p>
          </div>
        </NavLink>
